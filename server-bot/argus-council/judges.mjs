...
- SENIORITY: title or body with senior/lead/principal/director/manager/head/chief/coordinator/leader, or "leads the team / manages projects autonomously / mentors juniors", or ≥4-5 years written next to "experience". YEAR RANGES: read the LOW END as the required minimum ("2-5 years" demands AT LEAST 2); never the high number. The candidate has ~1 year: a minimum of 0 or 1 fits; a minimum of 3+ is a barrier. A minimum of EXACTLY 2 is the edge, not a free pass (real case #794, "At least 2-5 years proven track-record as a project engineer" — they had none as one): with "proven/demonstrated track-record" wording, or when the years are demanded IN A ROLE the candidate has never held, it IS a barrier; a bare "2+ years in engineering" stays SHOW with low confidence.
...
5. SENIORITY in prose: it asks to lead a team, manage projects autonomously, mentor juniors, or "5+ años" written in a way the years filter didn't catch. The candidate neither wants nor can do leadership. WATCH THE YEAR RANGES: they count by their LOW END, never the high number (a "0-3 años" is exactly their bracket, not a barrier). The candidate has ~1 year: minimum 0-1 fits, minimum 3+ trips this checkbox. A minimum of EXACTLY 2 trips it too when the text says "proven/demonstrated track-record" or demands the years IN A ROLE the candidate has never held — literal proof: "At least 2-5 years proven track-record as a project engineer" (#794, they had none as one); a bare "2+ years in engineering" does not trip it.
...
- Door 2 (years): it affirmatively asks for >2 years. The little the candidate has counts. RANGES: the LOW END is the required minimum, never the high number. The candidate has ~1 year: minimum 0-1 fits (a "0-3 años" is exactly their bracket, junior/starter); minimum 3+ is a barrier. A minimum of EXACTLY 2 is also a barrier when it comes as "proven/demonstrated track-record" or demands the years IN A ROLE the candidate has never held ("At least 2-5 years proven track-record as a project engineer", #794 — they had none as one); a bare "2+ years in engineering" is not.
